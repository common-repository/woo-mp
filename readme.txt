...
* Declare support for WordPress 6.6.
* Declare support for WooCommerce 9.x.
* Update the Stripe API version.

= 2.8.3 =

* Fix a fatal error that some users have been getting ([`Class "WC_Settings_Page" not found`](https://wordpress.org/support/topic/php-fatal-error-uncaught-error-class-wc_settings_page-not-found/)).

= 2.8.2 =

* Declare support for WordPress 6.5.
